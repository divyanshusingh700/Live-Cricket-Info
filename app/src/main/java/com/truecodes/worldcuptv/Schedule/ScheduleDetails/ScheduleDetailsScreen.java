package com.truecodes.worldcuptv.Schedule.ScheduleDetails;
...
import com.truecodes.worldcuptv.Schedule.ScheduleDetails.Fragments.MatchInfoFragment;
...
public class ScheduleDetailsScreen extends AppCompatActivity {
    AdManager adManager;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_schedule_details_screen);
        NoInternetDialogPendulum.Builder builder = new NoInternetDialogPendulum.Builder(this, getLifecycle());
        builder.getDialogProperties().setConnectionCallback(new ConnectionCallback() { // from class: com.digital.livecricketapp.Schedule.ScheduleDetails.ScheduleDetailsScreen.1
            @Override
    ...
    private void addTabs(ViewPager viewPager) {
        ...
        viewPagerAdapter.addFrag(new MatchInfoFragment(), "Match Info");
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public void addFrag(Fragment fragment, String str) {
            ...
            bundle.putString("teamAName", ScheduleDetailsScreen.this.teamAName);
            bundle.putString("teamBName", ScheduleDetailsScreen.this.teamBName);
            bundle.putString(ImagesContract.URL, ScheduleDetailsScreen.this.url);
